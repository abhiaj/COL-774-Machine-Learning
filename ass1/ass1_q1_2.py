...
for i in range (len(array_j)):
    ...
    print("A")
    plt.pause(0.002)
    # ax.plot(theta_arr[:,0], theta_arr[:,1], array_j, color='r', alpha=0.5)
...
CS = plt.contour(M[0:i,:], B[0:i,:], Z[0:i,:], 25)
plt.clabel(CS, inline=1, fontsize=10)
plt.plot([theta[0,0]], [theta[0,1]], color='r', marker='x', label='Optimal Value')
for i in range(len(array_j)):
